...
class RestaurantFavourite extends AppModel
{
    ...
    public function getMyFavouriteRestaurant($user_id,$restaurant_id)
    {
        ...
        $data =  $this->find('all', array(
            ...
            'fields' => array("favourite")

        ));
        
        if(@$data[0]["RestaurantFavourite"]["favourite"]=="1")
          return 1;
        else 
          return 0;
       //eturn $data[0]['RestaurantFavourite']['favourite'];

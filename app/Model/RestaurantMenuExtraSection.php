...
class RestaurantMenuExtraSection extends AppModel
{
    ...
    //keep
    public function getExtraSectionIds($id)
    {
        $sections = $this->find('all', array(
            'conditions' => array(
                'RestaurantMenuExtraSection.restaurant_menu_item_id' => $id
            )
        ));
        ...
        foreach($sections as $section){
            array_push($IDs, $section['RestaurantMenuExtraSection']['id']);
        }
    ...
    //keep
    public function deleteMenuExtraSections($id)
    {
